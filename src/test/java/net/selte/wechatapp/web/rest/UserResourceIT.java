...
public class UserResourceIT {
    ...
    /**
     * This repository is mocked in the net.selte.wechatapp.repository.search test package.
     *
     * @see net.selte.wechatapp.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
