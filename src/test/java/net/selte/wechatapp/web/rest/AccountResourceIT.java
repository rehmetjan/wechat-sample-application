package net.selte.wechatapp.web.rest;

import static net.selte.wechatapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.selte.wechatapp.WechatSampleApplicationApp;
import net.selte.wechatapp.config.Constants;
import net.selte.wechatapp.domain.User;
import net.selte.wechatapp.repository.AuthorityRepository;
import net.selte.wechatapp.repository.UserRepository;
import net.selte.wechatapp.security.AuthoritiesConstants;
import net.selte.wechatapp.service.UserService;
import net.selte.wechatapp.service.dto.PasswordChangeDTO;
import net.selte.wechatapp.service.dto.UserDTO;
import net.selte.wechatapp.web.rest.vm.KeyAndPasswordVM;
import net.selte.wechatapp.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = WechatSampleApplicationApp.class)
